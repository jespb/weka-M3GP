 ...
 *
 */
public class TreeM3GPMutationHandler {
	/**
	...
	public static TreeM3GP mutation(TreeM3GP original, String[] op, String[] term, 
		...
		case 0:		//Mutacao normal
			...
			break;
		case 1:		//Add dimensao
			dim.add(new Node(op,term,t_rate,0,max_depth));
			break;
		case 2: 	//Remove dimensao
			dim.remove((int)(dim.size()*Math.random()));
			break;
		}
		return new TreeM3GP(dim);
	}
