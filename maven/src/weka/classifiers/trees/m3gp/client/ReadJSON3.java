...
public class ReadJSON3 {
	...
	public static void main(String [] args) throws IOException{
		...
		double[][][] goa1 = new double[gens][runs][10];
		double[][][] goa2 = new double[gens][runs][10];
		double[][][] goa3 = new double[gens][runs][10];
		...
		System.out.print("Writing the genetic operator counts and probabilities...");
		out.write("# 15th generation: Average probability of the population, probability of the individual, count of the individual\n");
		out.write(matrixToR("pop_goa_"+15, goa1[14]));
		out.write(matrixToR("ind_goa_"+15, goa2[14]));
		out.write(matrixToR("int_goac_"+15, goa3[14]));
		out.write("\n");
		
		out.write("# 25th generation: Average probability of the population, probability of the individual, count of the individual\n");
		out.write(matrixToR("pop_goa_"+25, goa1[24]));
		out.write(matrixToR("ind_goa_"+25, goa2[24]));
		out.write(matrixToR("int_goac_"+25, goa3[24]));
		out.write("\n");
		
		out.write("# 50th generation: Average probability of the population, probability of the individual, count of the individual\n");
		out.write(matrixToR("pop_goa_"+50, goa1[49]));
		out.write(matrixToR("ind_goa_"+50, goa2[49]));
		out.write(matrixToR("int_goac_"+50, goa3[49]));
		out.write("\n");
		
		out.write("# 100th generation: Average probability of the population, probability of the individual, count of the individual\n");
		out.write(matrixToR("pop_goa_"+100, goa1[99]));
		out.write(matrixToR("ind_goa_"+100, goa2[99]));
		out.write(matrixToR("int_goac_"+100, goa3[99]));
		out.write("\n");
		System.out.println("(done)");
		...
		out.write("\r\n" + 
				"print(\"\\nTrain values for the last generation (quantile, stdev, values)\")\r\n" + 
				"print(quantile(tr_Euclidean[100,]))\r\n" + 
				"print(sd(tr_Euclidean[100,]))\r\n" + 
				"print(tr_Euclidean[100,])\r\n" + 
				"\r\n" + 
				"print(\"\\nTest values for the last generation (quantile, stdev, values)\")\r\n" + 
				"print(quantile(te_Euclidean[100,]))\r\n" + 
				"print(sd(te_Euclidean[100,]))\r\n" + 
				"print(te_Euclidean[100,])\r\n" + 
				"\r\n" + 
				"print(\"\\nMedian of the number of node on the last generation\")\r\n" + 
				"print(median(nodes[100,]))\r\n" + 
				"\r\n" + 
				"print(\"\\nMedian of the dimensions of node on the last generation\")\r\n" + 
				"print(median(dimensions[100,]))\r\n" + 
				"\r\n" + 
				"print(\"\\nMedian of the operators probabilities in each generation (15th, 25th, 50th, and 100th\")\r\n" + 
				"for (i in 1:5) print(median(pop_goa_15[i]))\r\n" + 
				"\r\n" + 
				"for (i in 1:5) print(median(pop_goa_25[i]))\r\n" + 
				"\r\n" + 
				"for (i in 1:5) print(median(pop_goa_50[i]))\r\n" + 
				"\r\n" + 
				"for (i in 1:5) print(median(pop_goa_100[i]))\r\n" + 
				"\r\n" + 
				"\r\n" + 
				"print(\"\\nFrequency of dimensions on the 15th generation\")\r\n" + 
				"m15 = matrix(ncol = 50, nrow=1)\r\n" + 
				"for (i in 1:50) m15[,i] = 0\r\n" + 
				"for (i in dimensions[15,]) m15[1,i] = m15[1,i] + 1\r\n" + 
				"print(m15)\r\n" + 
				"\r\n" + 
				"print(\"\\nFrequency of dimensions on the 25th generation\")\r\n" + 
				"m25 = matrix(ncol = 50, nrow=1)\r\n" + 
				"for (i in 1:50) m25[,i] = 0\r\n" + 
				"for (i in dimensions[25,]) m25[1,i] = m25[1,i] + 1\r\n" + 
				"print(m25)\r\n" + 
				"\r\n" + 
				"print(\"\\nFrequency of dimensions on the 50th generation\")\r\n" + 
				"m50 = matrix(ncol = 50, nrow=1)\r\n" + 
				"for (i in 1:50) m50[,i] = 0\r\n" + 
				"for (i in dimensions[50,]) m50[1,i] = m50[1,i] + 1\r\n" + 
				"print(m50)\r\n" + 
				"\r\n" + 
				"print(\"\\nFrequency of dimensions on the 100th generation\")\r\n" + 
				"m100 = matrix(ncol = 50, nrow=1)\r\n" + 
				"for (i in 1:50) m100[,i] = 0\r\n" + 
				"for (i in dimensions[100,]) m100[1,i] = m100[1,i] + 1\r\n" + 
				"print(m100)\r\n" + 
				"		");
